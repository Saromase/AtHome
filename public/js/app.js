...
console.log(localStorage.theme); // Whenever the user explicitly chooses light mode

localStorage.theme = 'light'; //   localStorage.theme = 'dark'

console.log(localStorage.theme); // Whenever the user explicitly chooses to respect the OS preference
